...
Unicode字符出
    ...
    字符串内建函数:
        ...
        center(width, fillchar) 返回一个指定的宽度 width 居中的字符串fillchar 为填充的字符,默认为空格。

        count(str, beg= 0,end=len(string)) 返回 str 在 string 里面出现的次数,
        如果 beg 或者 end 指定则返回指定范围内 str 出现的次数

        bytes.decode(encoding="utf-8", errors="strict") Python3 中没有 decode 方法,
        ...
        如果 beg 或者 end 指定则检查指定的范围内是否以 suffix 结束,如果是,返回 True,否则返回 False。
        ...
        translate(table, deletechars="") 根据 table 给出的表(包含 256 个字符)转换string 的字符
